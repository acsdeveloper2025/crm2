...
## 2 — Claude file-memory (this machine)
...
---
*Keep this current: when a phase completes or a freeze changes, update `CRM2_MASTER_MEMORY.md` §8, the relevant doc, and the Claude memory files. `AGENTS.md` mirrors this file for non-Claude agents — edit both together.*

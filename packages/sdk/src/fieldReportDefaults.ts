...
const RESIDENCE_COLUMNS: ReportLayoutColumnInput[] = [
  ...
  F('applicant_staying_floor', 'Applicant Staying Floor', 'addressFloor'),
...
const BUSINESS_COLUMNS: ReportLayoutColumnInput[] = [
  ...
  FD('business', 'business_approx_area', 'Business Approx Area', 'officeApproxArea'),
...
const RCO_COLUMNS: ReportLayoutColumnInput[] = [
  ...
  FD('residence-cum-office', 'applicant_staying_floor', 'Applicant Staying Floor', 'addressFloor'),
  FD(
  ...
  FD('residence-cum-office', 'approx_area', 'Approx Area', 'officeApproxArea'),

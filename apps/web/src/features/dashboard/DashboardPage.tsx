 ...
 * drives the pipeline counter bar + today's throughput/trend + the out-of-TAT late-work read, all filtered to
    ...
    <div className="space-y-5">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          ...
          throughput and out-of-TAT work across the work you can see.
        </p>
      </div>
      ...
      {stats.isError ? (
        ...
        <>
          ...
          {/* The headline late-work read + the oldest-unassigned read, side by side. */}
          <div className="grid grid-cols-1 gap-3 lg:grid-cols-3">
            <div className="lg:col-span-2">
              <KpiCard
                label="Out of TAT"
                value={s?.overdue}
                sub="tasks past their TAT — click to view"
                to="/pipeline?overdue=1"
                tone="alert"
              />
            </div>
            <KpiCard

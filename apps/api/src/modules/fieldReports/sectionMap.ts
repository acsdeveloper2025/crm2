  ...
  residence: [
    ...
    },
    {
      ...
      fields: [
        ...
        { ref: 'addressFloor', label: 'Applicant Staying Floor' },
  ...
  business: [
    {
      ...
      fields: [
        ...
        { ref: 'businessExistance', label: 'Business Existence (NSP)' },
    ...
    },
    {
      ...
      fields: [
        ...
        { ref: 'companyNatureOfBusiness', label: 'Nature of Business' },
        { ref: 'officeApproxArea', label: 'Business Approx Area' },
  ...
  'residence-cum-office': [
    ...
    },
    {
      ...
      fields: [
        ...
        { ref: 'companyNatureOfBusiness', label: 'Nature of Business' },
        { ref: 'officeApproxArea', label: 'Approx Area' },
      ],
    },
    {
      title: 'Property / Nameplate & Documents',
  ...
  'property-individual': [
    {
      ...
      fields: [
        ...
        { ref: 'flatStatus', label: 'Flat Status' },
        { ref: 'finalStatus', label: 'Final Status' },
      ],
    },
    {
